<template>
  <div>
        ...
        <div class="chip-wifi">
          <svg  class="wifi-svg"
            ...
            <g opacity="0.5">
              ...
              <path99 d="M35.8186 21.073C36.4967 21.7382 36.4967 22.817 35.8186 23.4826C35.1397 24.1482 34.0397 24.1482 33.3612 23.4826C27.0956 17.339 16.9004 17.339 10.6348 23.4826C9.95633 24.1482 8.85545 24.1482 8.17785 23.4826C7.83861 23.15 7.66833 22.7135 7.66833 22.2778C7.66833 21.8412 7.83861 21.406 8.17785 21.073C11.869 17.4538 16.7772 15.4608 21.9978 15.4608C27.2184 15.4608 32.1266 17.4538 35.8186 21.073Z" fill="black"  />
    ...
    <form @submit.prevent="createCard" id="form">
      ...
      <h5 v-if="showError">you need to fill up all info</h5>
      <input type="submit" />
    </form>
  </div>
</template>
